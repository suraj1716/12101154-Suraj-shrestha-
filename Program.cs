...
namespace ConsoleApplication
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                // Input date
                Console.WriteLine("Enter current Date: dd/mm/yyyy ");   //Line Added
                ...
                // Vat after Tax
                double Vat_after_Tax = Vat(totalCost);   //Line Added
                ...
                Console.WriteLine("Date: {0}", Date);  // Line Added
                ...
                Console.WriteLine("Price after Vat {0}", Vat_after_Tax);  //Line Added
            ...
            //funtion for Vat
            double Vat(double T)   //Added
            {
                double v_perc = 0.03;
                double Total_Vat = v_perc * T;
